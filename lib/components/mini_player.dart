              ...
              return Dismissible(
                ...
                child: Dismissible(
                  ...
                  child: ValueListenableBuilder(
                    ...
                    builder: ((context, Box box1, Widget? child) {
                      final bool useDense =
                          box1.get('useDenseMini', defaultValue: false);
                      final List preferredMiniButtons = Hive.box('settings')
                          .get('preferredMiniButtons',
                              defaultValue: ['我的喜欢', '播放/暂停', '下一首'])?.toList();
